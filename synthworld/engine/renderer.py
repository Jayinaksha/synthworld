...
from panda3d.core import (
    ...
    CollisionRay, CollisionSphere, Fog,
    loadPrcFileData
)
import numpy as np
...
class Renderer(ShowBase):
    ...
    def _setup_lighting(self):
        ...
        self.ambient_light.setColor(Vec4(0.6, 0.6, 0.7, 1))  # Brighter ambient
        self.ambient_light_np = self.render.attachNewNode(self.ambient_light)
        self.render.setLight(self.ambient_light_np)
        
        # Sun (directional light) - brighter
        self.sun_light = DirectionalLight('sun')
        self.sun_light.setColor(Vec4(1.2, 1.1, 1.0, 1))  # Brighter sun
        ...
        # Vertex colors will blend with lighting automatically
        
        # Fog for cyberpunk atmosphere
        self.fog = Fog("SceneFog")
        self.fog.setColor(0.05, 0.02, 0.1)  # Match background color
